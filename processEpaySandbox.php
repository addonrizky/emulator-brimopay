...
curl_setopt($ch, CURLOPT_URL, "http://172.18.104.76/payment_gateway/InsertPaymentParameters?payeeId=".$payid."&billReferenceNo=".$bilref."&keysTrxEcomm=".$keysTrxEcomm);
...
if($result->respond == "00"){
	echo "<form action='http://sandbox.bri.co.id/pg/ePayment' method='post' name='frm'>";
